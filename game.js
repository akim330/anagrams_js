...
Game = function(is_server){
    ...
    if (is_server){
        var twl_module = require('./twl.js');
        this.twl_dict = twl_module('./TWL06.txt');
    }
    else{
    ...
    this.can_take = function(take){
        console.log("Checking if can take");
        console.log(`take.victim: ${take.victim}, take.taken_word: ${take.taken_word}, take.used_tiles: ${take.used_tiles}, current: ${this.current}, player1words_list: ${this.player1words_list}, player2words_list: ${this.player2words_list}`);
        if (take.victim == 1){
    ...
    this.check_steal = function(candidate, etym_candidate, is_player2){
        ...
        if (is_player2){
            ...
            console.log(`player 2 words list: ${this.player2words_list}`)
            word_list = this.player2words_list;
            word_dict = this.player2words_dict;
        }
        else{
            console.log('is not player2')
            console.log(`player 1 words list: ${this.player1words_list}`)
